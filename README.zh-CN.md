...
1. 打开 [Releases](https://github.com/junhey/MenuBarCalendar/releases) 页面。
2. 下载最新版的 `MenuBarCalendar-v0.0.3.zip`。
3. 解压后将 `MenuBarCalendar.app` 拖入 **应用程序**（或 `~/Applications`）。
4. 启动应用 — 图标出现在菜单栏（无 Dock 图标）。

> 若 macOS 提示来自未识别开发者，可右键应用 → **打开** → 确认。
...
- [v0.0.3](https://github.com/junhey/MenuBarCalendar/releases/tag/v0.0.3) — 开源专业化、CI、Releases 分发
